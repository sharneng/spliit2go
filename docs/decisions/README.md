...
| [multi-group-design.md](multi-group-design.md) | Per-group server URL and active user, the group list as the app root, and asking "Who are you?" once per group ([#2](https://github.com/sharneng/spliit2go/issues/2), [#12](https://github.com/sharneng/spliit2go/issues/12), [#85](https://github.com/sharneng/spliit2go/issues/85)) |
