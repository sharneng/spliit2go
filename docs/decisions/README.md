...
| [multi-group-design.md](multi-group-design.md) | Per-group server URL and active user, the group list as the app root, asking "Who are you?" once per group, the "You" section on Balances where it can be changed, creating a group, sharing its link, and reading links pasted from messages ([#2](https://github.com/sharneng/spliit2go/issues/2), [#12](https://github.com/sharneng/spliit2go/issues/12), [#85](https://github.com/sharneng/spliit2go/issues/85), [#99](https://github.com/sharneng/spliit2go/issues/99), [#115](https://github.com/sharneng/spliit2go/issues/115), [#3](https://github.com/sharneng/spliit2go/issues/3), [#118](https://github.com/sharneng/spliit2go/issues/118)) |
